...
ASR_PIPELINE = pipeline(
    ...
    model="cdactvm/telugu_w2v-bert_model",
...
def text_to_speech(text, output_filename :str, speaker_id = 19, style_id = 0):
    """
...
def main(path :str,unique_filename :str):
    ...
    if not os.path.exists(raw_audio_file):
        ...
        if transcription:
            print(f"Original Transcription in Telugu: {transcription}")
            ...
            print(f"Translated Text (Telugu to English): {translated_text}")
        else:
        ...
        if translated_text:
            ...
            translated_text_tel = translate_text_with_model_en(
                llm_response,
                TRANSLATION_MODEL1,
            ...
            print(f"LLM Response Translated Back to Telugu: {translated_text_tel}")

            # Pass the Telugu response to TTS
            output_audio_file = text_to_speech(translated_text_tel, output_filename=f"{unique_filename}_output.wav")
